...
ip_table.info.data_field_annotation_add(
    field_name="dstAddr", action_name="Ingress.ipv4_forward", custom_annotation="ipv4"
)
client.info_table(ip_table)
client.dump_table(ip_table)
# client.dump_entry(ip_table, ["$dstAddr", "prefix_len"], [key, 32])

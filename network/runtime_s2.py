...
slice_ident.add_with_set_sliceid(src_addr='10.0.2.21', dst_addr='10.0.1.11', protocol=1, slice_id=1)
slice_ident.add_with_set_sliceid(src_addr='10.0.2.22', dst_addr='10.0.1.12', protocol=1, slice_id=2)
slice_ident.add_with_set_sliceid(src_addr='10.0.1.11', dst_addr='10.0.2.21', protocol=1, slice_id=3)
slice_ident.add_with_set_sliceid(src_addr='10.0.1.12', dst_addr='10.0.2.22', protocol=1, slice_id=4)

slice_ident.add_with_set_sliceid(src_addr='10.0.2.21', dst_addr='10.0.1.11', protocol=6, slice_id=1)
slice_ident.add_with_set_sliceid(src_addr='10.0.2.22', dst_addr='10.0.1.12', protocol=6, slice_id=2)
slice_ident.add_with_set_sliceid(src_addr='10.0.1.11', dst_addr='10.0.2.21', protocol=6, slice_id=3)
slice_ident.add_with_set_sliceid(src_addr='10.0.1.12', dst_addr='10.0.2.22', protocol=6, slice_id=4)


slice_ident.add_with_set_sliceid(src_addr='10.0.2.21', dst_addr='10.0.1.11', protocol=17, slice_id=1)
slice_ident.add_with_set_sliceid(src_addr='10.0.2.22', dst_addr='10.0.1.12', protocol=17, slice_id=2)
slice_ident.add_with_set_sliceid(src_addr='10.0.1.11', dst_addr='10.0.2.21', protocol=17, slice_id=3)
slice_ident.add_with_set_sliceid(src_addr='10.0.1.12', dst_addr='10.0.2.22', protocol=17, slice_id=4)
